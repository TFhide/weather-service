...
class WeatherApiServiceImplTest {
    ...
    public static final WeatherApiProperties PROPERTIES = new WeatherApiProperties(
            "https://api.weatherbit.io", "/v2.0", "/current",
            "X-RapidAPI-Key", "your_api_key", "ru_RU", 1, 7);
    @Mock
    ...
    @BeforeEach
    void setUp() {
        weatherApiService = new WeatherApiServiceImpl(PROPERTIES, httpClient, objectMapper);
    }
    ...
    void shouldReturnExpectedMessageOnRequestOfCurrentDayForecastBasedOnStatusCodeInsteadOfThrowingAnException(
        ...
        CompletableFuture<String> result = weatherApiService.getCurrentDayForecastUsingExternalService(COORDINATE);
    ...
    void shouldReturnExpectedMessageOnRequestOfWeeklyForecastBasedOnStatusCodeInsteadOfThrowingAnException(
        ...
        CompletableFuture<String> result = weatherApiService.getWeeklyForecastUsingExternalService(COORDINATE);
